...
/// </summary>
public class UtilitiesPlugin : Plugin<PluginConfig>
{
    /// <summary>
    /// The version of the current assembly.
    /// </summary>
    public const string CurrentVersion = "1.1.4.0";
    ...
    internal static PluginConfig PluginConfig => Instance.Config;
    internal static AutoGeneratedConfig AutoGeneratedConfig = new();

    private GameObject _handlerObject;
    private readonly Harmony _harmony = new("com.frikandelbroodje.utils");

    internal static void Save() => Instance.SaveConfig(AutoGeneratedConfig, "AutoGeneratedConfig.yml");
    ...
    public override void Enable()
    {
        ...
        AutoGeneratedConfig = this.LoadConfig<AutoGeneratedConfig>("AutoGeneratedConfig.yml");
